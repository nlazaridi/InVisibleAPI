...
parser.add_argument('--data', default= '/data2/nlazaridis/places365_standard',
                    help='path to dataset')
 
parser.add_argument('--arch', '-a', default='resnet18', help='model architecture: ' + ' | '.join(model_names) +' (default: resnet18)')
 
parser.add_argument('-j', '--workers', default=12, type=int, help='number of data loading workers (default: 4)')
 
parser.add_argument('--epochs', default=90, type=int, help='number of total epochs to run')
 
parser.add_argument('--start-epoch', default=0, type=int, help='manual epoch number (useful on restarts)')

parser.add_argument('-b', '--batch-size', default=512, type=int, help='mini-batch size (default: 256)')
...
parser.add_argument('--resume', default='/home/nlazaridis/Desktop/python_scripts/places365-master/resnet18_best.pth.tar', type=str, help='path to latest checkpoint (default: none)')
parser.add_argument('-e', '--evaluate', dest='evaluate', action='store_true',
                    help='evaluate model on validation set')
parser.add_argument('--pretrained', dest='pretrained', action='store_false',
                    help='use pre-trained model')
parser.add_argument('--num_classes',default=375, type=int, help='num of class in the model')
...
def main():
    ...
    counts_tensor = count_images_in_subfolders(traindir)
    tensor = torch.full((375,),5000)
    class_weights = tensor/counts_tensor
...
def count_images_in_subfolders(folder_path):
    ...
    for subfolder in subfolders:
        image_count = len([f for f in os.listdir(subfolder) if f.endswith(('.jpg', '.png', '.jpeg'))])
        image_counts.append(image_count)

    image_counts_tensor = torch.tensor(image_counts)

    return image_counts_tensor
